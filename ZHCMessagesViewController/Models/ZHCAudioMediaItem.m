...
-(void)setAudioDataURL:(NSString *)audioDataURL{
//    NSLog(audioDataURL);
    _audioDataURL = audioDataURL;
//    if (self.audioDataURL) {
    
//        self.audioPlayer = [[AVAudioPlayer alloc] init];
//        //        NSLog(self.audioDataURL.absoluteString);
//        //        self.audioPlayer = [[AVAudioPlayer alloc] init];
...
//        NSLog(self.audioDataURL);
//    }
//    NSLog(@"%@", self.playButton);
    if (self.audioData == nil) {
...
//                [self.playButton setImage:[UIImage imageNamed:@""] forState:UIControlStateNormal];
...
- (UIView *)mediaView
{
    if (self.audioDataURL && self.cachedMediaView == nil) {
//        if (self.audioData) {
...
//        }
        ...
        //NSLog(@"%@", self.audioViewAttributes.backgroundColor);
        ...
        NSString *durationString = [self timestampString: self.audioDuration
                                             forDuration: self.audioDuration];
