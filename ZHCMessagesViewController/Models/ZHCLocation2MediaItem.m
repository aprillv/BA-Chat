...
@end
@implementation ZHCLocation2MediaItem
...
- (BOOL)isEqual:(id)object
{
    ...
    ZHCLocation2MediaItem *locationItem = (ZHCLocation2MediaItem *)object;
...
{
    ZHCLocation2MediaItem *copy = [[[self class] allocWithZone:zone] initWithLocation:self.location];
